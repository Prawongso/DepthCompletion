...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='ui\Pluralistic-Inpainting-master\checkpoints', help='models are save here')
        ...
        # data pattern define
        parser.add_argument('--img_file', type=str, default='inpaintput', help='training and testing dataset')
